...
//   const [currMatch, setCurrMatch] = useState(1);
//   const nextMatch = () => {
//     if (currMatch !== userData.length) {
...
//       {userData.map((ob, ind) => {
//         return (
//           <div className={currMatch === ind + 1 ? "fade" : "slide"}>
...
//                       return (
//                         <span id="circlePassion"> {userPassion[index]} </span>
//                       );
//                     })}
//                   </div>
//                 </div>
...
//             style={{ color: "rebeccapurple" }}
//           />
//           <CloseIcon onClick={nextMatch} className="dtbtn" id="cbtn" style={{ color: "red" }} />
//           {userData.bio ? (
//             <div className="Userbio">
//               <h4>About</h4>
//               <p>{props.bio}</p>
